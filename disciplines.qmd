...
![Adapted version of The Turing Way project illustration by Scriberia. Used under a CC-BY 4.0 licence.
DOI: [The Turing Way Community & Scriberia
(2024)](https://doi.org/10.5281/ZENODO.3332807).](fig/domains.jpg)
...
- The data for this analysis are collected from the option `currentEmp13` for the year 2022.
...
- The script for this analysis is available in the
file [discipline.R](https://github.com/SaranjeetKaur/RSE_historical_analysis/blob/main/src/discipline.R)
of the repository.
