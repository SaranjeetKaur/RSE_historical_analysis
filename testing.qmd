...
[proj4_test.R](https://github.com/SaranjeetKaur/RSE_historical_analysis/blob/main/src/proj4_test.R) of the repository.
...
conducting the test**. Moreover, the 2022 data also reports the use of **automated testing with continuous
integration**. This suggests a change towards using good software engineering practices.
