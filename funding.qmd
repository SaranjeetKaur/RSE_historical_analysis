...
Funding is an important aspect of the RSE role as it enables RSEs to dedicate time and
resources to their work. In this section, we analyse the funding sources for RSE work over
the years.
...
[fund.R](https://github.com/SaranjeetKaur/RSE_historical_analysis/blob/main/src/fund.R) of the repository.
