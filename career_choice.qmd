...
- The data for this analysis are collected from the option `prevEmp2` for the years 2017, 2018, and 2022.
- The period from 2019 to 2021 is not reported as the data for these years are not available.
- This code contains the responses to the survey question _"Rank the following factors dependent on how strongly 
they influenced your decision to accept your current position"_.
...
- "_Opportunity to develop software_"
- "_Freedom to choose own working practices_" 
- "_Desire to work in research environment_" 
- "_Desire to advance research_"
